...
# ----------------------------------------
# If GPIO_DDIO_out is one of several IP cores in your
...
# ----------------------------------------
# ACDS 16.1 203 linux 2019.10.02.09:26:49
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "GPIO_DDIO_out"
}
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "/opt/edes/altera/16.1.2/quartus/"
}
...
ensure_lib               ./libraries/GPIO_DDIO_out/
vmap       GPIO_DDIO_out ./libraries/GPIO_DDIO_out/
...
alias com {
  echo "\[exec\] com"
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_gpio_lite/altera_gpio_lite.sv"        -work GPIO_DDIO_out
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_gpio_lite/mentor/altera_gpio_lite.sv" -work GPIO_DDIO_out
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/GPIO_DDIO_out.vhd"                                              
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L GPIO_DDIO_out -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L fiftyfivenm_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L fiftyfivenm $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L GPIO_DDIO_out -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L fiftyfivenm_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L fiftyfivenm $TOP_LEVEL_NAME
}
