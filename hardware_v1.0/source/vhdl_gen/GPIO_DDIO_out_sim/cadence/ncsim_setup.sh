...
TOP_LEVEL_NAME="GPIO_DDIO_out"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/opt/edes/altera/16.1.2/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
mkdir -p ./libraries/GPIO_DDIO_out/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/altera_gpio_lite/altera_gpio_lite.sv" -work GPIO_DDIO_out -cdslib ./cds_libs/GPIO_DDIO_out.cds.lib
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/GPIO_DDIO_out.vhd"                                                                                
fi
